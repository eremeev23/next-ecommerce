...
import DarkMode from "@material-ui/icons/WbSunnyOutlined";
    ...
    <header className={headerStyle}>
      <div className="dark:text-white custom-container mx-auto py-4 flex justify-between align-center">
        ...
        <div className="flex-[3] flex justify-center">
          <Link href='/' className='font-bold text-2xl leading-[inherit] transition-colors hover:text-red dark:hover:text-toxic'>
            WEAR THIS.
          </Link>
        </div>

        <div className='flex-1 hidden sm:flex justify-end gap-4'>
          <button className='h-10 w-24 border-3 text-lg font-bold transition-colors hover:text-white dark:hover:text-black dark:hover:border-white dark:hover:bg-white hover:bg-black-600'>
            Log in
          </button>
          <button className='h-10 w-24 border-3 text-lg font-bold transition-colors hover:text-white dark:hover:text-black dark:hover:border-white dark:hover:bg-white hover:bg-black-600'>
            Sign up
